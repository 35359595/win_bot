...
function getPlayerMove(data) {
    ...
    let attack = () => {
        ...
        let xSetter = ballStop.x - currentPlayer.x - ballRadius * 1.8 + (ballStop.x < currentPlayer.x ? ballRadius / 5 : random(1, 4));
