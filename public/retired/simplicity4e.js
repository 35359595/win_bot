...
function getPlayerMove(data) {
    ...
    var defend = () => {
    return Math.atan2(
        ballStop.y - currentPlayer.y + (Math.abs(ball.y - currentPlayer.y) < ballRadius * 2 ? (ballStop.y > currentPlayer.y ? - (ballRadius * 2 - (ball.y - currentPlayer.y)) * 2 : + (ballRadius * 2 - (ball.y - currentPlayer.y) * 2)) : 0),
