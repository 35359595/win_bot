...
function getPlayerMove(data) {
    ...
    var defend = () => {
    return Math.atan2(
        ballStop.y - currentPlayer.y + ((Math.abs(currentPlayer.y - ballStop.y) > ballRadius * 2) ? 0 : ballStop.y < currentPlayer.y ? ballRadius : - ballRadius),
        ballStop.x <= 0 ? ballRadius : ballStop.x - currentPlayer.x - ballRadius * 1.9
        );
    };
